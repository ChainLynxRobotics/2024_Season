...
public class Drivetrain extends SubsystemBase {
  ...
  public Drivetrain() {
    ...
    m_odometry =
        new SwerveDriveOdometry(
            ...
            Rotation2d.fromRadians(-m_gyro.getAngle()),
  ...
  public void drive(
    ...
    double rotDelivered = m_currentRotation * DriveConfig.kMaxAngularSpeed;
  ...
  public void setModuleStates(SwerveModuleState[] desiredStates) {
    SwerveDriveKinematics.desaturateWheelSpeeds(
        desiredStates, DriveConfig.kMaxSpeedMetersPerSecond);
  ...
  /**
   * returns the current speed of the robot from its reference frame
   *
   * @return the current speed of the robot from its reference frame
   */
